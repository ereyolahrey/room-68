    ...
    <div className="app-container">
      ...
      <aside className="sidebar glass-sidebar">
        <div className="sidebar-logo">
          ...
          <div>
            <h1>Room 68</h1>
            <span style={{ fontSize: '0.6rem', color: 'var(--accent)', letterSpacing: '0.15em', textTransform: 'uppercase', opacity: 0.8 }}>Built on Arc</span>
          </div>
        </div>
